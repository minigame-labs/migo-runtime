...
sidebar:
  order: 4
description: Android ShareHandler contract — ShareRequest fields, ShareSink settle semantics, and the "shareAppMessage:fail not supported" fallback when no handler is registered.
