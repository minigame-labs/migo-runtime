...
sidebar:
  order: 7
description: Android GameLogHandler contract — the JSON structure of JS game log entries received by the host, forwarding boundaries, and the logcat fallback when no handler is registered.
