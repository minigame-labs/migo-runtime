...
sidebar:
  order: 3
description: Android SettingHandler contract — the UI-delegation model of openSetting, the dual-write requirement of SettingSink, and the "openSetting:fail not supported" settle semantics when no handler is registered.
