...
sidebar:
  order: 1
description: "The Android AdHandler contract: eight ad forms, adId handle semantics, and why the isEnded=false close in fallback settle is a safety net rather than a recommendation. This page covers only the Android Java layer."
sourcePaths:
