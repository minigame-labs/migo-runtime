...
sidebar:
  order: 2
description: RuntimeConfig is the immutable session configuration — directories,
  frame rate, orientation, immersive mode, debug level, ANR watchdog, and code
  signing. Construction must go through Builder.
audience: host-integrator
platforms:
  - android
sourcePaths:
  - platforms/android/library/src/main/java/com/migo/runtime/RuntimeConfig.java
slug: en/0.9/android-sdk/config
---
