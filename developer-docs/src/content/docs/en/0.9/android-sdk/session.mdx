...
sidebar:
  order: 3
description: GameSession lifecycle — startGame/pause/resume/close, the three
  Surface callbacks, touch forwarding, 10 set*Handler setters plus setListener
  (11 registration points total), and state broadcasts.
audience: host-integrator
platforms:
  - android
sourcePaths:
  - platforms/android/library/src/main/java/com/migo/runtime/GameSession.java
slug: en/0.9/android-sdk/session
---
...
Install these before opening the package; see the detailed contract in [Host capabilities overview](/docs/en/0.9/capabilities/overview/):
