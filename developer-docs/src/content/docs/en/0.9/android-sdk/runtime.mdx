...
sidebar:
  order: 1
description: "Android SDK entry point: singleton, version and status queries,
  four createSession variants, and Safe-variant error-return semantics."
audience: host-integrator
platforms:
  - android
sourcePaths:
  - platforms/android/library/src/main/java/com/migo/runtime/MigoRuntime.java
slug: en/0.9/android-sdk/runtime
---
