...
sidebar:
  order: 6
description: Integrate the Migo C SDK into an OpenHarmony host app, mount an
  OHNativeWindow through an ArkUI XComponent, and verify touch input.
...
slug: en/0.9/getting-started/openharmony
---
