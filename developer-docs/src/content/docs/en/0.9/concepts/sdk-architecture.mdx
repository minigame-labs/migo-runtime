...
Diagrams show function names only; full signatures are in the [Session](/docs/en/0.9/reference/session/) and [Surface](/docs/en/0.9/reference/surface/) reference pages.
