...
sidebar:
  order: 2
description: 'The Android PaymentHandler contract: two request forms, the
  synchronous answer from isMidasPaymentSupported, and the meaning of dual
  signatures. Why the default "refuse sales" behavior is the best answer for
  content.'
...
slug: en/0.9/capabilities/commerce/payment
---
