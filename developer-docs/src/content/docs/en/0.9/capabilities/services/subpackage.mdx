...
sidebar:
  order: 5
description: Android SubpackageHandler contract — zip input and output of the
  download method, atomic verification and mounting, and local-file fallback
  with failure semantics when no handler is registered.
...
slug: en/0.9/capabilities/services/subpackage
---
