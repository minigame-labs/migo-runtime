...
sidebar:
  order: 1
description: Connecting ANativeWindow to the engine Surface on Android —
  descriptor construction, the generation counter pitfall, and JNI
  initialization timing for pure C hosts.
...
slug: en/0.9/platform-binding/android
---
...
[Surface Interface](/docs/en/0.9/reference/surface/); for Session lifecycle see
[Lifecycle Concepts](/docs/en/0.9/concepts/lifecycle/).
