...
sidebar:
  order: 2
description: Connecting the OHNativeWindow from an ArkUI XComponent to the
  engine Surface on OpenHarmony, and correctly managing asynchronous release.
...
slug: en/0.9/platform-binding/openharmony
---

This page covers only the platform-binding delta for OpenHarmony. The general
attach / detach / release contract is described in [Surface Interface](/docs/en/0.9/reference/surface/);
for Session foreground/background state see [Lifecycle Concepts](/docs/en/0.9/concepts/lifecycle/).
