...
Sessions must be destroyed before their Engine; a Surface attachment must complete the detach/release flow before its Session can be destroyed. See [engine.mdx](/docs/reference/engine/), [session.mdx](/docs/reference/session/), and [surface.mdx](/docs/reference/surface/).
