...
attach / detach / release contract is described in [Surface Interface](/docs/reference/surface/);
for Session foreground/background state see [Lifecycle Concepts](/docs/concepts/lifecycle/).
