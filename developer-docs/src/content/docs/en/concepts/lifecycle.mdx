...
sidebar:
  order: 3
description: The engine session's three-state machine (CREATED/RUNNING/PAUSED), orthogonal channels for visibility and focus, the vsync-driven frame model, and ownership semantics of destroy.
