...
After reading this page, if you want to walk through the state machine, continue with the destroy section of [Session Lifecycle](/docs/concepts/lifecycle/); for function-level C ABI signatures, see the [Session](/docs/reference/session/) and [Surface](/docs/reference/surface/) reference pages.
