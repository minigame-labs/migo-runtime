...
sidebar:
  order: 4
description: All negative ErrorCode values (host side) and the native positive-code range (engine side), the recoverable semantics of MigoException, and diagnostic paths.
...
| `207 NATIVE_CODE_SIGNATURE_INVALID` | Code signature verification failed — remember the pubkey chain in [RuntimeConfig](/docs/android-sdk/config/) |
