...
sidebar:
  order: 5
description: The responsibilities and selection of MigoGameView (self-contained lifecycle), MigoGameActivity, ConsoleLogView, and DebugOverlayView.
