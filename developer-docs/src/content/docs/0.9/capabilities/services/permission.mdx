...
sidebar:
  order: 2
description: Android PermissionHandler 合同:requestScope 的问答模型、PermissionSink 的
  setScope/resolveRequest/failRequest 三条通道、无 handler 时全拒行为的设计原因。
...
slug: 0.9/capabilities/services/permission
---
