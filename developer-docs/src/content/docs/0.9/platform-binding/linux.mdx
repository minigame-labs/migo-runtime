...
slug: 0.9/platform-binding/linux
---

本页只覆盖 Linux 的两个原生 surface 形状。通用 ABI 字段、generation 和异步释放合同见 [Surface 接口](/docs/0.9/reference/surface/)；这里的目标是说明 X11 / Wayland 宿主各自要交给引擎什么，以及哪些对象必须继续存活。
