...
须由宿主自行串行化。Engine 的创建与销毁见 [engine.mdx](/docs/0.9/reference/engine/)；surface 的
attach、detach 与释放见 [surface.mdx](/docs/0.9/reference/surface/)。
...
原生窗口资源。详见 [surface.mdx](/docs/0.9/reference/surface/)。
